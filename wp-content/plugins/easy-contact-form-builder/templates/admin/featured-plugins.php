...
<div class="wrap gdfrm_featured_plugins_container">
    <div class="gdfrm_header">
        ...
        <ul>
            ...
            <li>
                <a href="https://wordpress.org/support/plugin/easy-contact-form-builder" target="_blank"><?php _e('Support Forum',GDFRM_TEXT_DOMAIN);?></a>
            </li>
            <li>
    ...
    <div class="gdfrm_content">
        ...
        <div class="single-plugin">
            ...
            <div class="plugin-info">
                ...
                <div class="plugin-buttons">
                    <a href="https://grandwp.com/wordpress-event-calendar" target="_blank">
        ...
        <div class="single-plugin">
            ...
            <div class="plugin-info">
                ...
                <div class="plugin-buttons">
                    <a href="https://grandwp.com/wordpress-responsive-lightbox" target="_blank">
                        <?php _e('Try Free',GDFRM_TEXT_DOMAIN);?>
                    </a>
                    <a href="https://demo.grandwp.com/wordpress-responsive-lightbox-demo/" target="_blank">
                        <?php _e('Demo',GDFRM_TEXT_DOMAIN);?>
                    </a>
                </div>
            </div>
        ...
        <div class="single-plugin">
            ...
            <div class="plugin-info">
                ...
                <div class="plugin-buttons">
                    <a href="https://grandwp.com/wordpress-photo-gallery" target="_blank">
                        <?php _e('Try Free',GDFRM_TEXT_DOMAIN);?>
                    </a>
